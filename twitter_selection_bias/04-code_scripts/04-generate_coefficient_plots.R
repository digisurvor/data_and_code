...
#### ---- LOAD MODEL OUTPUTS ---- ####
load(paste0(output_dir, "logit_model_coefficients.RData"))

#### ---- PLOT MODEL COEFFICIENTS ---- ####

# First, coefficients are capped at 5 to avoid extreme values distorting the plot
cap_val <- 5
results_capped <- results_joined |> 
  mutate(
...
ggsave(paste0(figures_dir,"model_coefficient_plot_pooled_regression.png"),
       model_plot1,
...
ggsave(paste0(figures_dir,"model_coefficient_plot_cross_national_comparison.png"),
       model_plot2,
...
ggsave(paste0(figures_dir,"model_coefficient_plot_within_country_comparison.png"),
       model_plot3,
       units="in", width=9, height=8, dpi=300,
       bg="white")
